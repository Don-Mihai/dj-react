...
const Calculator = () => {
  ...
  const calculateTotal = () => {
    const total = (parseInt(djPrice) + parseInt(hostPrice) + parseInt(artistPrice)) * hoursCount;
    setTotalCost(total);
  };
  ...
  return (
    <section id="calculator" className="calculator container">
      ...
      <form className="calculator__form">
        ...
        <div className="form-group">
          <button type="button" onClick={calculateTotal} className="button button-primary">
        ...
        <div className="form-group">
          <button type="button" onClick={handleOrderClick} className="button button-primary">
            Заказать
          </button>
        </div>

        <SendForm open={isModalOpen} handleClose={handleCloseModal} orderDetails={orderDetails} />
